...
const features = [
  {
    ...
    title: "Whey Protein",
    desc: "Made with whey protein concentrate, a milk ingredient. See the label for serving size.",
    rotate: "-1deg",
  },
  {
    icon: Leaf,
    stat: "12g",
    unit: "Fiber",
    title: "Chia Seed Fiber",
    desc: "Made with chia seeds. Read the nutrition panel for your selected flavor.",
    rotate: "0.5deg",
  },
  {
    icon: ShieldCheck,
    stat: "Read",
    unit: "The Label",
    title: "Ingredients by Flavor",
    desc: "Check the full ingredients and allergen statement before buying.",
    rotate: "-0.8deg",
  },
  {
    icon: Droplets,
    stat: "MCT",
    unit: "Oil",
    title: "Coconut-Derived MCT Oil",
    desc: "Medium chain coconut oil triglycerides are included in the supplied ingredients.",
    rotate: "1.2deg",
  },
  {
    icon: Heart,
    stat: "Check",
    unit: "Sugar Content",
    title: "Flavor-Specific Nutrition",
    desc: "Chocolate Chips includes cane sugar. Read the selected flavor’s nutrition panel.",
    rotate: "-0.5deg",
  },
  {
    icon: Sparkles,
    ...
    unit: "Allergen",
    title: "Contains Milk",
    desc: "Our current flavors contain whey protein. They are not vegan or dairy-free.",
    rotate: "0.8deg",
  },
]
