...
export default function LandingContact() {
  ...
  async function submitMessage(event: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      formElement.reset(); setPurpose('general')
    } catch (error) {
  ...
  return (
    ...
    >
      ...
      <div className="relative mx-auto max-w-[1400px] px-3 md:px-10">
        <div className="grid grid-cols-1 items-start gap-12 lg:grid-cols-2 lg:gap-16">
          ...
          >
            ...
            <div className="flex flex-wrap gap-4 pt-2">
              {/* Instagram */}
              {settings.socialLinks.instagram && (<a target="_blank" rel="noopener noreferrer" href={settings.socialLinks.instagram}
                ...
                style={{ fontFamily: FONT, fontWeight: 900, background: "linear-gradient(135deg, rgb(68,15,195) 0%, rgb(158,38,182) 100%)", color: "white", boxShadow: "3px 3px 0 rgba(255,255,255,1)" }}
              >
              ...
              {/* Facebook */}
              {settings.socialLinks.facebook && (<a target="_blank" rel="noopener noreferrer" href={settings.socialLinks.facebook}
                className="shimmer-btn relative isolate flex cursor-pointer items-center justify-center gap-2.5 overflow-hidden rounded-sm border-3 border-white px-6 py-3 text-xs font-black uppercase tracking-widest text-white transition-all duration-200 ease-out hover:-translate-x-0.5 hover:-translate-y-0.5 hover:shadow-[3px_3px_0px_rgba(255,255,255,1)] hover:brightness-105 active:translate-x-0 active:translate-y-0 active:shadow-[1px_1px_0px_rgba(255,255,255,1)]"
                style={{ fontFamily: FONT, fontWeight: 900, background: "linear-gradient(135deg, rgb(68,15,195) 0%, rgb(158,38,182) 100%)", color: "white", boxShadow: "3px 3px 0 rgba(255,255,255,1)" }}
              >
                <svg className="h-4 w-4 shrink-0" viewBox="0 0 24 24" fill="currentColor">
              ...
              {/* TikTok */}
              {settings.socialLinks.tiktok && (<a target="_blank" rel="noopener noreferrer" href={settings.socialLinks.tiktok}
                className="shimmer-btn relative isolate flex cursor-pointer items-center justify-center gap-2.5 overflow-hidden rounded-sm border-3 border-white px-6 py-3 text-xs font-black uppercase tracking-widest text-white transition-all duration-200 ease-out hover:-translate-x-0.5 hover:-translate-y-0.5 hover:shadow-[3px_3px_0px_rgba(255,255,255,1)] hover:brightness-105 active:translate-x-0 active:translate-y-0 active:shadow-[1px_1px_0px_rgba(255,255,255,1)]"
                style={{ fontFamily: FONT, fontWeight: 900, background: "linear-gradient(135deg, rgb(68,15,195) 0%, rgb(158,38,182) 100%)", color: "white", boxShadow: "3px 3px 0 rgba(255,255,255,1)" }}
              >
                <svg className="h-4 w-4 shrink-0" viewBox="0 0 24 24" fill="currentColor">
